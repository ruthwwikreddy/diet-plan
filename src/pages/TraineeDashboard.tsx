...
import { Eye, Download, Calendar, CheckSquare } from 'lucide-react';
  ...
  return (
    <Layout>
      <div className="container mx-auto p-4 md:p-6">
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-muscle-gray">Trainee Dashboard</h1>
          <p className="text-muted-foreground">Track your progress and view your diet plans</p>
        </div>
